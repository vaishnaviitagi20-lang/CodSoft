...
export default function Jobs() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-ink-50 dark:bg-ink-900/50 transition-colors">
      <Navbar />
      ...
      <div className="page-container py-8 flex-1">
        ...
        <div className="lg:hidden mb-4 flex items-center justify-between">
          <p className="text-sm text-ink-500 dark:text-ink-400">{total} results</p>
        ...
        <div className="flex gap-6">
          ...
          <main className="flex-1 min-w-0">
            {loading ? (
              ...
              <div className="card dark:bg-ink-900/80 p-16 text-center">
                <p className="text-5xl mb-4">🔍</p>
                <h3 className="font-semibold text-ink-900 dark:text-white text-lg mb-2">No jobs found</h3>
                <p className="text-ink-400 dark:text-ink-300 mb-6">Try adjusting your filters or search terms.</p>
              ...
              <>
                ...
                {pages > 1 && (
                  <div className="flex items-center justify-center gap-2 mt-8">
                    ...
                    <span className="text-sm text-ink-500 dark:text-ink-400 px-3">Page {page} of {pages}</span>
