      ...
      <div className="page-container">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <span className="font-display text-xl font-semibold text-ink-900 dark:text-white transition-colors">
          ...
          <div className="flex items-center gap-3">
            ...
            {!user ? (
              ...
              <div className="relative" ref={dropRef}>
                ...
                {dropOpen && (
                  <div className="absolute right-0 top-full mt-2 w-52 bg-white dark:bg-ink-900 rounded-2xl shadow-xl dark:shadow-ink-900/50 border border-ink-100 dark:border-ink-800 py-2 animate-fade-in transition-colors">
